...
fn insert_episode(
  ...
  let query =
    ...
    |> pog.parameter(pog.nullable(pog.text, episode.title_ja))
    |> pog.parameter(pog.int(episode.importance))
    |> pog.parameter(pog.nullable(pog.int, episode.netflix_id))
    |> pog.parameter(pog.nullable(pog.text, episode.netflix_synopsis))
    |> pog.parameter(pog.nullable(pog.text, episode.url_imdb))
