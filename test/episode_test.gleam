...
pub fn decode_episode_test() {
  let json_string =
    ...
    \"organizations\": [
      ...
      {\"name\": \"Bajoran Provisional Government\", \"contrast\": 5}
    ]
  }"
...
pub fn decode_episodes_from_json_test() {
  let sample_json =
    "[{\"season\":1,\"episode\":1,\"title\":\"Emissary\",\"title_ja\":\"聖なる神殿の謎\",\"importance\":4,\"netflix_id\":70205806,\"characters\":[{\"name\":\"Benjamin Sisko\",\"contrast\":4},{\"name\":\"Dax\",\"contrast\":4}],\"organizations\":[{\"name\":\"Federation\",\"contrast\":5},{\"name\":\"Bajoran Provisional Government\",\"contrast\":5}]}]"
